...
values ('f0000000-0000-0000-0000-00000000000b', 'f0000000-0000-0000-0000-00000000000a', 1, 'f0000000-0000-0000-0000-00000000000b', now(), now() + interval '3 weeks');
select issue_ticket('f0000000-0000-0000-0000-00000000000b', 'intro_s14_a', 5000, 'intro');
set local role authenticated;
select open_intro();
