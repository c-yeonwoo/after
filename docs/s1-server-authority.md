...
> **2026-09-20 S36에서 판정 정책이 바뀌었다.** 아래는 S4 당시 구현 기록이다.
> 현재는 인정·부인·24시간 무응답을 모두 운영자 검토 큐로 보내며 자동 확정하지
> 않는다. 현재 계약은 `docs/prd-after-mvp.md` P4와 `s36_safety_ai_ops.sql`을 따른다.
