...
export const Route = createFileRoute("/feedback")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "만남이 어땠는지 남기면 다음 소개가 더 정확해집니다. 상대에게는 공개되지 않습니다.",
      },
...
const RESULTS = [
  ...
  { id: "noshow", label: "만나지 못했어요" },
];

const NOTES = ["대화가 편했어요", "예의 있었어요", "약속을 잘 지켰어요", "프로필과 달랐어요", "불편한 순간이 있었어요"];
...
function FeedbackPage() {
  ...
  return (
    <AppScreen title="만남 후 피드백" hideTabs>
